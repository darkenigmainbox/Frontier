...
export const DESERT_GROUPS: { label: string; names: string[] }[] = [
  { label: 'Cacti · columnar & barrels', names: ['Saguaro', 'Cardon', 'Organ Pipe', 'Golden Barrel', 'Fishhook Barrel'] },
  { label: 'Cacti · prickly pears', names: ['Prickly Pear', 'Teddy-Bear Cholla'] },
  { label: 'Succulents · rosettes', names: ['Century Plant', 'Agave in Bloom', 'Aloe Vera', 'Echeveria'] },
