...
import { SucculentParams, DEFAULT_SUCCULENT, SucculentForm } from '../plant/succulentParams';
...
export interface TreeParams {
  ...
  grass?: GrassParams;
  /** Xeric description (kind === 'succulent'). */
...
function succulentPreset(
  name: string,
  form: SucculentForm,
  botany: Partial<BotanyParams>,
  succulent: Partial<SucculentParams>,
  mesh: Partial<MeshParams> = {},
  roots: Partial<RootParams> = {},
): TreeParams {
  const base = preset(name, botany, mesh, { ...roots, enabled: roots.enabled ?? false });
  return {
    ...base,
    kind: 'succulent',
    succulent: { ...DEFAULT_SUCCULENT, form, ...succulent },
  };
}
...
export const TREE_PRESETS: TreeParams[] = [
  ...
  succulentPreset(
    ...
    'saguaro',
    {
      ...
      baseSize: L(0.2, 0.05, 0.02, 0.02),
      length: L(1, 0.48, 0, 0),
      lengthV: L(0.04, 0.12, 0, 0),
      taper: L(0.32, 0.24, 1, 1),
      curveRes: L(12, 8, 1, 1),
      curve: L(4, 22, 0, 0),
      curveBack: L(-5, -16, 0, 0),
      curveV: L(24, 55, 0, 0),
      bendV: L(9, 30, 0, 0),
      segSplits: L(0, 0, 0, 0),
      splitAngle: L(0, 0, 0, 0),
      splitAngleV: L(0, 0, 0, 0),
      downAngle: L(0, 50, 0, 0),
      downAngleV: L(0, 12, 0, 0),
      rotate: L(0, 137.5, 0, 0),
      rotateV: L(0, 24, 0, 0),
      branches: L(1, 4, 0, 0),
      branchDist: L(0, 0, 0, 0),
      radiusMod: L(1, 0.95, 1, 1),
      attractionUp: 1,
      flatten: 0,
      leaves: 0,
      leafScale: 0,
    ...
    { form: 'saguaro', ribCount: 12, ribDepth: 0.035, ribSoftness: 0.22, spineCount: 84, spineLength: 0.042 },
    { trunkRadialSegments: 32, minRadialSegments: 8, collarScale: 1.42, collarFillet: 0.85, collarRings: 2 },
    { count: 5, radius: 0.4, length: 0.16, laterals: 1, forks: 0.15 },
  ),
  ...
  succulentPreset(
    ...
    'barrel',
    {
      ...
      ratioPower: 1,
      flare: 0.08,
      baseSize: L(0.04, 0, 0, 0),
      length: L(0.96, 0, 0, 0),
      lengthV: L(0.04, 0, 0, 0),
      taper: L(1.65, 1, 1, 1),
      curveRes: L(14, 1, 1, 1),
      curve: L(0, 0, 0, 0),
      curveBack: L(0, 0, 0, 0),
    ...
    { form: 'barrel', ribCount: 20, ribDepth: 0.065, ribSoftness: 0.38, spineCount: 108, spineLength: 0.028 },
    { trunkRadialSegments: 40, minRadialSegments: 12, collarRings: 0 },
    { count: 4, radius: 0.35, length: 0.11, laterals: 0, forks: 0 },
  ),
  ...
  succulentPreset(
    ...
    { form: 'prickly-pear', rosetteCount: 11, rosetteLength: 0.72, rosetteWidth: 0.52, rosetteVariation: 0.2, padBulge: 0.09 },
    { trunkRadialSegments: 24, minRadialSegments: 8 },
    { count: 4, radius: 0.28, length: 0.12, laterals: 0, forks: 0 },
  ),
  ...
  succulentPreset(
    ...
    { form: 'agave', rosetteCount: 42, rosetteLength: 0.9, rosetteWidth: 0.12, rosetteLean: 38, rosetteDroop: 18, rosetteVariation: 0.2 },
    { trunkRadialSegments: 24, minRadialSegments: 8 },
    { count: 4, radius: 0.3, length: 0.14, laterals: 0, forks: 0 },
  ),
  ...
  succulentPreset(
    ...
    { form: 'aloe', rosetteCount: 30, rosetteLength: 0.52, rosetteWidth: 0.105, rosetteLean: 48, rosetteDroop: 26, rosetteVariation: 0.24 },
    { trunkRadialSegments: 20, minRadialSegments: 8 },
    { count: 3, radius: 0.3, length: 0.1, laterals: 0, forks: 0 },
  ),
...
export const PRESET_GROUPS: { label: string; names: string[] }[] = [
  ...
  { label: 'Desert · cacti & succulents', names: ['Joshua Tree', 'Desert Ironwood', 'Saguaro Cactus', 'Golden Barrel Cactus', 'Prickly Pear Cactus', 'Agave Americana', 'Aloe Vera'] },
